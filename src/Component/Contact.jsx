...
import { FaEnvelope, FaMapMarkerAlt, FaLinkedin, FaUser, FaPaperPlane, FaGithub } from 'react-icons/fa';
        ...
        <motion.div variants={itemVariants} className="w-full">
          <div className="bg-gray-800/50 rounded-lg p-6 backdrop-blur-sm border border-gray-700/50 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                <div className="p-2 rounded-lg bg-gray-700/50 group-hover:bg-blue-500/20 transition-colors duration-300">
